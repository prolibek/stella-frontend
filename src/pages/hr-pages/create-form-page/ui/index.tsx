...
export const CreateFormPage = () => {
    ...
    const handleAPIRequest = () => {
        ...
        try {
            ...
            const response = $api.post(`organisations/${tenant}/vacancy-forms/`, requestData);
    ...
    const handleAddField = (index: number) => {
        ...
        newFields.splice(index + 1, 0, { name: "", type: "Short", options: [] });
        setFields(newFields);
                                ...
                                <div className={s.fieldUpperPart}>
                                    ...
                                    {focusedFieldIndex === index && (
                                        <div className={s.buttonContainer}>
                                            <BlueButton text="+" onClick={() => handleAddField(index)} style={{
                                                height: 35,
                                                width: 35,
                                                display: "flex",
                                            ...
                                            <BlueButton onClick={() => handleDeleteField(index)} style={{
                                                height: 35,
                                                width: 35,
                                                display: "flex",
                                                justifyContent: "center",
